  ...
  return (
    <>
      <div className="absolute top-0 flex w-full justify-end space-x-[1.3rem] p-[1.5rem] text-[1.4rem] ">
        ...
        >
          <ResetSvg className=" h-[2.2rem] w-[2.2rem]" />
        </button>
        <button
          className="cursor-pointer hover:text-gray-500"
          onClick={() => setIsSetting(true)}
        >
          <SettingSvg className=" h-[2.2rem] w-[2.2rem]" />
        </button>
      </div>

      <div className="flex h-full w-full   justify-center space-x-[7rem] space-y-0">
        ...
        <div className="flex flex-col items-center justify-center ">
          ...
          <div className="flex w-full flex-col space-y-3">
            <button
              className="H3  mx-auto w-full max-w-[13rem]  rounded bg-primary-100 p-2 text-primary-500"
      ...
      {isSetting && (
        <div className="absolute top-0 flex h-full w-full flex-col items-center rounded-[1rem] bg-primary-sub3">
          <div className="absolute flex w-full justify-end p-[1.5rem]">
            <span onClick={() => setIsSetting(false)}>
              <CancelSvg className="h-[2.2rem] w-[2.2rem] cursor-pointer" />
            </span>
          </div>
          <TimerForm
            onSubmit={onSubmit}
