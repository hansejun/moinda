...
const Status = () => {
  ...
  return (
    <div className="my-[2.6rem] h-[26.5rem] w-[44.6rem] gap-[1.4rem] rounded-[1rem] bg-white px-[3rem] py-[2.4rem]">
      <h2 className="H2 my-[1.8rem]">스터디 현황</h2>
      <div className="flex justify-between">
        {users.map((user) => (
          <div
            key={user.num}
            className="flex-center h-[6.4rem] w-[12.3rem] flex-col rounded-[1rem] bg-[#F5F4F3]"
          >
